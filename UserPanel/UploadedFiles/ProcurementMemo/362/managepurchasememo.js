...
import { GetAllProcurementMemos, GetCommonProcurementUserDetails,ProcurementMemoGetById } from "common/data/mastersapi";
        ...
        return (
            <div className="d-flex align-items-center justify-content-center gap-2">
                ...
                {rowData.Status ==='Saved' ? (
                 ...
                 <span onClick={()=>handleCancelled(rowData)} style={{cursor:'pointer'}}>
                    <Tag value="❌" style={{backgroundColor:'white', border:'1px solid red', fontSize: '7px'}}/>
                </span>      
                  {/*<span onClick={()=>handleACK(rowData)} style={{cursor:'pointer'}}>
                    <Tag value='Ack' style={{backgroundColor:'#FF7F27', fontSize: '9px'}}/>
                </span>   */}       
                            ...
                            <Card>
                                <DataTable
                                    ...
                                    >
                                           ...
                                           <Column field="PM_Number" sortable  body={actionclaimBodyTemplate} header="PM Number" filter className="text-left" filterPlaceholder="Search by PM_Number" />
