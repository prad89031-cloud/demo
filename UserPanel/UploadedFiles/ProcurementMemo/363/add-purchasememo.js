                                            ...
                                            <Form>
                                                                    ...
                                                                    {editingRowIndex !== i ? (
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                {/* <AutoComplete
                                                                                    ...
                                                                                    className="my-autocomplete"
                                                                                /> */}
                                                                                {errors.items?.[i]?.department && touched.items?.[i]?.department && (
                                                                                    <div className="text-danger small">{errors.items[i].department}</div>
                                                                                )}
                                                                            </td>
                                                ...
                                                <div className="col-xl-12 mt-lg-4">
                                                    <Col md="12">
                                                        ...
                                                        <button type="button" className="btn btn-success " onClick={toggleAttachmentModal}>
